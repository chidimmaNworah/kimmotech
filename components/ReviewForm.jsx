...
const ReviewForm = () => {
  ...
  return (
    <div className="flex items-center justify-center">
              <span onClick={() => setButtonPopup(true)} className="transition duration-500 transform hover:-translate-y-1 inline-block bg-[#020024] text-lg font-meduim rounded text-white px-4 py-3 cursor-pointer">
                  Write a review
              </span>
