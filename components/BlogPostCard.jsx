  ...
  return (
    ...
    <Link key={post.slug} href={`/blog/${post.slug}`}>
      <div className="bg-white p-2 shadow-sm rounded-sm">
        <a href="#" className="overflow-hidden block theBlogImage">
        ...
        <div className="mt-3">
          <h3 className="text-sm cursor-pointer font-semibold text-gray-700 hover:text-blue-500 transition pb-2 theBlogTitle">{post.title}</h3>
